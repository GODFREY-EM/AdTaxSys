...
use App\Http\Controllers\Dashboard\FinanceReportController;
...
Route::middleware('auth')->group(function () {
    Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard'); // Removed duplicate 'auth' middleware
...
// ====== FINANCE ======
Route::middleware(['permission:finance.menu'])->group(function () {
