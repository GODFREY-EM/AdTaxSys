            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{ Request::is('pos*') ? 'active' : '' }}">
                    <a href="{{ route('pos.index') }}" class="svg-icon">
                        <img src="{{ asset('assets/images/POS.svg') }}" alt="POS Icon" style="width: 20px; height: 20px;">
                ...
                <li>
                    <a href="#products" class="collapsed" data-toggle="collapse" aria-expanded="false">
                        ...
                        <img src="{{ asset('assets/images/products.svg') }}" alt="Products Icon" style="width: 20px; height: 20px;">
                ...
                <li class="{{ Request::is('employees*') ? 'active' : '' }}">
                    <a href="{{ route('employees.index') }}" class="svg-icon">
                        ...
                        <img src="{{ asset('assets/images/employees.svg') }}" alt="Employees Icon" style="width: 20px; height: 20px;">
                ...
                <li class="{{ Request::is('customers*') ? 'active' : '' }}">
                    <a href="{{ route('customers.index') }}" class="svg-icon">
                        ...
                        <img src="{{ asset('assets/images/customers.svg') }}" alt="Customers Icon" style="width: 20px; height: 20px;">
                ...
                <li class="{{ Request::is('suppliers*') ? 'active' : '' }}">
                    <a href="{{ route('suppliers.index') }}" class="svg-icon">
                        ...
                        <img src="{{ asset('assets/images/suppliers.svg') }}" alt="Suppliers Icon" style="width: 20px; height: 20px;">
                ...
                <li>
                    <a href="#attendence" class="collapsed" data-toggle="collapse" aria-expanded="false">
                        <img src="{{ asset('assets/images/attendance.svg') }}" alt="Products Icon" style="width: 20px; height: 20px;">
                ...
                <li class="{{ Request::is('users*') ? 'active' : '' }}">
                    <a href="{{ route('users.index') }}" class="svg-icon">
                        <img src="{{ asset('assets/images/users.svg') }}" alt="Users Icon" style="width: 20px; height: 20px;">
