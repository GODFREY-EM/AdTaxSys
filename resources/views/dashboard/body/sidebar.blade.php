<div class="iq-sidebar sidebar-default ">
    <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
        <a href="{{ route('dashboard') }}" class="header-logo">
            ...
            <h5 class="logo-title light-logo ml-3">SBC</h5>
        </a>
                ...
                @if (auth()->user()->can('pos.menu'))
                    <li class="{{ Request::is('pos*') ? 'active' : '' }}">
                        <a href="{{ route('pos.index') }}" class="svg-icon">
                            <img src="{{ asset('assets/images/POS.svg') }}" alt="POS Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('orders.menu'))
                    <li>
                        <a href="#orders" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <img src="{{ asset('assets/images/orders.svg') }}" alt="Orders Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('product.menu'))
                    <li>
                        <a href="#products" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <!-- Insert the custom icon (SVG or image) -->
                            <img src="{{ asset('assets/images/products.svg') }}" alt="Products Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('reporting.menu'))
                    <li>
                        <a href="#reporting" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <img src="{{ asset('assets/images/reporting.svg') }}" alt="Reporting Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('employee.menu'))
                    <li class="{{ Request::is('employees*') ? 'active' : '' }}">
                        <a href="{{ route('employees.index') }}" class="svg-icon">
                            <!-- Replace FontAwesome icon with a custom SVG for Employees -->
                            <img src="{{ asset('assets/images/employees.svg') }}" alt="Employees Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('customer.menu'))
                    <li class="{{ Request::is('customers*') ? 'active' : '' }}">
                        <a href="{{ route('customers.index') }}" class="svg-icon">
                            <!-- Replace FontAwesome icon with a custom SVG for Customers -->
                            <img src="{{ asset('assets/images/customers.svg') }}" alt="Customers Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('supplier.menu'))
                    <li class="{{ Request::is('suppliers*') ? 'active' : '' }}">
                        <a href="{{ route('suppliers.index') }}" class="svg-icon">
                            <!-- Replace FontAwesome icon with a custom SVG for Suppliers -->
                            <img src="{{ asset('assets/images/suppliers.svg') }}" alt="Suppliers Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('attendence.menu'))
                    <li>
                        <a href="#attendence" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <img src="{{ asset('assets/images/attendance.svg') }}" alt="Products Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('roles.menu'))
                    <li>
                        <a href="#permission" class="collapsed" data-toggle="collapse" aria-expanded="false">
                            <img src="{{ asset('assets/images/roles.svg') }}" alt="Products Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('user.menu'))
                    <li class="{{ Request::is('users*') ? 'active' : '' }}">
                        <a href="{{ route('users.index') }}" class="svg-icon">
                            <img src="{{ asset('assets/images/users.svg') }}" alt="Users Icon"
                                style="width: 20px; height: 20px;">
                ...
                @if (auth()->user()->can('database.menu'))
                    <li class="{{ Request::is('database/backup*') ? 'active' : '' }}">
                        <a href="{{ route('backup.index') }}" class="svg-icon">
                            <img src="{{ asset('assets/images/database.svg') }}" alt="Database Icon"
                                style="width: 20px; height: 20px;">
